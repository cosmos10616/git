...
2. [FPGA高手能力路线图](./FPGA高手能力路线图.md)：数字基础、验证、STA、CDC、定点、数据流、工具流程和结合F0工程的训练路线。
3. [工程导读](./工程导读.md)：第一次浏览整个F0工程时从这里开始。
4. [MIMO收发端总结与项目面试问答](./MIMO收发端总结与项目面试问答.md)：收发端MIMO主线、DRAM关联和项目深挖。
5. [紫光国芯数字前端面试准备](./紫光国芯数字前端面试准备.md)：自我介绍、前端基础与手撕RTL。
